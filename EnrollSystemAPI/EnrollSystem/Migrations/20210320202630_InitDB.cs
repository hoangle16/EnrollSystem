        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdNumber = table.Column<string>(maxLength: 16, nullable: false),
                    PhoneNumber = table.Column<string>(maxLength: 16, nullable: true),
                    Address = table.Column<string>(nullable: true),
                    IsActive = table.Column<bool>(nullable: false, defaultValue: true),
                    Role = table.Column<string>(nullable: true, defaultValue: "student")
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TrainingImages_Images_ImageId",
                        column: x => x.ImageId,
                        principalTable: "Images",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainingImages_Students_StudentId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainingImages_ImageId",
                table: "TrainingImages",
                column: "ImageId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_TrainingImages_StudentId",
                table: "TrainingImages",
                column: "StudentId");
