...
namespace EnrollSystem.Migrations
{
    ...
    [Migration("20210320202630_InitDB")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnrollSystem.Entities.EnrollImage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("EnrollImages");
                });

            modelBuilder.Entity("EnrollSystem.Entities.Enrollment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EnrollSystem.Entities.EnrollImage", b =>
                {
                    ...
                    b.HasOne("EnrollSystem.Entities.Image", "Image")
                        .WithOne("EnrollImage")
                        .HasForeignKey("EnrollSystem.Entities.EnrollImage", "ImageId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });
